...
class RobotControl:
    ...
    def _establish_position(self, average_front_data, average_right_data, average_left_data, corridor_width, previous_position, is_turning):
        ...
        if is_turning:
            ...
            #If VERY limited space out front...
            if average_front_data <= corridor_width:
                ...
                if ((average_right_data*0.85) < average_left_data < (average_right_data*1.15)):
                    current_position = "end_of_maze"
                # ... and left wall distances are greater than right wall distances plus 15%, then we're in a left corner
                elif (average_left_data >= (average_right_data*1.15)):
                    current_position = "corner_left"
                # ...and right wall distances are greater than left wall distances plus 15%, then we're in a right corner
                elif (average_right_data >= (average_left_data*1.15)):
                    current_position = "corner_right"
                else:
                    current_position = "undetermined"
            #If SOME space out front...
            elif (average_front_data < (corridor_width * 2)):
                ...
                #...and left wall distances are greater than right wall distances plus 15%, then we're approaching a left corner
                elif (average_left_data >= (average_right_data*1.15)):
                    current_position = "corridor_opening_left"
                #...and right wall distances are greater than left wall distances plus 15%, then we're approaching a right corner
                elif (average_right_data >= (average_left_data*1.15)):
            ...
            #If LOTS of space out front... 
                ...
                #...and the left wall and right distances are pretty close to eachother, then we're likely in a normal corridor still
                if ((average_right_data*0.7) < average_left_data < (average_right_data*1.3)):
                    current_position = "corridor"
                #...and left wall distances are greater than right wall distances plus 30%, then we're looking down a new corridor after completing a left turn!
                elif (average_left_data >= (average_right_data*1.3)):
                    current_position = "corridor_after_left_turn"
                #...and right wall distances are greater than left wall distances plus 30%, then we're looking down a new corridor after completing a right turn!
                elif (average_right_data >= (average_left_data*1.3)):
